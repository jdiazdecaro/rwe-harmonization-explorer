// Pure, environment-agnostic transform from raw Airtable rows into the shape
// the dashboard consumes. Shared by the browser fetch (fetchAirtableData.js)
// and the build-time snapshot script (scripts/fetch-data.mjs) so the two can
// never drift apart.
